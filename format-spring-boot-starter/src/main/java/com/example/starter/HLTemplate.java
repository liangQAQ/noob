...
import com.example.starter.configuration.HelloProperties;

public class HLTemplate {

    private FormatProcessor formatProcessor;

    private HelloProperties helloProperties;

    public HLTemplate(HelloProperties helloProperties, FormatProcessor formatProcessor) {
